<ul class="relative z-10">
    ...
    <li>
        ...
        <ul class="flex justify-around">
            <li class="w-[200px] h-[200px] border rounded-3xl flex justify-center items-center"><a href="" class=" hover:underline text-blue-600 ">Association praticien-spécialité</a></li>
            <li class="w-[200px] h-[200px] border rounded-3xl flex justify-center items-center"><a href="patients/create" class=" hover:underline text-blue-600">Création d'un patient</a></li>
